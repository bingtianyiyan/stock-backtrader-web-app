...
import core.trading.trading_service as trading_service
from core.common.trading_models import TradingResult, BuyParameter, SellParameter
...
from core.trading.trading_schemas import QueryStockQuoteSetting
...
def buy(buy_position_strategy: BuyParameter):
    if platform.system() == "Windows":
        return
        # from core.broker.qmt.context import qmt_context
        #
