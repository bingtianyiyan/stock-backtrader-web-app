...
import core.api.kdata as kdata_api
import core.contract.api as contract_api
from core.common.query_models import TimeUnit
from core.domain import Stock, StockQuote, Stock1mQuote
from core.tag.tag_schemas import StockTags, StockPools
from core.trading.common import ExecutionStatus
from core.trading.trading_models import (
...
from core.trading.trading_schemas import TradingPlan, QueryStockQuoteSetting, TagQuoteStats
...
def cal_quote_stats(quote_df):
    ...
    if records:  # checks if list is not empty
        return records[0]
    else:
        return {}  # or whatever makes sense for your use case when there's no data
