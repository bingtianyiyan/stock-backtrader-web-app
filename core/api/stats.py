...
from core.api.kdata import get_kdata_schema, default_adjust_type, get_latest_kdata_date, get_trade_dates
from core.api.selector import get_entity_ids_by_filter
from core.api.utils import get_recent_report_date
from core.contract import Mixin, AdjustType
from core.contract.api import get_entity_schema, get_entity_ids, decode_entity_id
from core.contract.drawer import Drawer
from core.domain import FundStock, StockValuation, BlockStock, Block
...
# 按月获取某类金融资产（如股票）中表现最好的标的（即涨幅最高的股票或指数），并以生成器（yield）的方式逐月返回结果
