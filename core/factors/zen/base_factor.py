...
from core.contract.drawer import Rect
from core.contract.factor import Accumulator
from core.contract.factor import Transformer
from core.domain import Stock, Index, Index1dKdata
from core.factors.algorithm import intersect, combine
from core.factors.shape import (
    Fenxing,
    Direction,
...
from core.utils.time_utils import TIME_FORMAT_ISO8601, to_time_str
